...
export const SYNC_TABLES: SyncTableSpec[] = [
  {
    name: "clients",
    columns: ["name", "company", "address", "phone", "email", "tax_number", "contacts", "notes", "created_at"],
    fks: [],
  },
  {
    name: "people",
    columns: ["type", "name", "specialization", "phone", "email", "bank_account", "hourly_rate_minor",
      "monthly_rate_minor", "currency", "notes", "is_active", "created_at"],
    fks: [],
  },
  {
  ...
  },
  {
    ...
    columns: ["code", "name", "client_id", "country", "city", "manager", "discipline", "project_type",
      "status", "currency", "fx_rate_micro", "start_date", "end_date", "progress_bp", "description", "created_at"],
  ...
  },
  {
    ...
    columns: ["project_id", "number", "title", "value_minor", "vat_bp", "retention_bp", "withholding_bp",
      ...
      "milestones", "drawings", "attachments", "signed_date", "notes", "created_at"],
  ...
  {
    name: "documents",
    columns: ["project_id", "category", "title", "path", "added_at"],
    fks: [{ column: "project_id", parent: "projects" }],
  },
  {
    name: "time_entries",
  ...
  },
  {
    ...
    columns: ["contract_id", "seq", "number", "date", "submission_date", "due_date_override", "description",
  ...
  },
  {
    ...
    columns: ["assignment_id", "date", "amount_minor", "note", "created_at"],
    fks: [{ column: "assignment_id", parent: "project_assignments" }],
  },
  {
    name: "expenses",
    columns: ["date", "category_id", "description", "project_id", "supplier", "amount_minor", "currency",
      "fx_rate_micro", "attachment_path", "person_payment_id", "created_at"],
    fks: [
