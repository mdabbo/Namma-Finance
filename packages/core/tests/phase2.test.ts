...
function fin(over: {
  ...
  return {
    ...
    contracts: [],
    contractValueMinor: 0, certifiedBaseMinor: 0, totalDueMinor: 0, totalPaidMinor: 0,
    outstandingMinor: 0, retentionHeldMinor: 0, certifiedRatioBp: 0, collectionRatioBp: 0,
    contractValueEgp: 0,
    revenueEgp: over.revenueEgp,
    collectedEgp: 0, outstandingEgp: 0,
